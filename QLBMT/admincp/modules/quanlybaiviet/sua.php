...
?>
<form method="POST" autocomplete="off" action="quanlybaiviet/xuly.php?idbaiviet=<?php echo $row['id'] ?>" enctype="multipart/form-data">
  <tr>
    <td>Tên bài viết</td>
  ...
  <tr>
    ...
    <td>
      ...
      <img src="../quanlybaiviet/uploads/><?php echo $row['hinhanh'] ?>" width="200px">
    </td>
  </tr>
  <tr>
    <td>Tóm tắt</td>
    <td><textarea rows="10" width="100%" name="tomtat" style="resize: none;"><?php echo $row['tomtat'] ?></textarea></td>
  </tr>
  <tr>
    <td>Nội dung</td>
  ...
  <tr>
    <td colspan="2px"><input type="submit" name="suabaiviet" value="Sửa bài viết"></td>
  </tr>
</form>
<?php
}

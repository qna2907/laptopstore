<b><p style="color: red; text-transform: uppercase;">Chi tiết sản phẩm</p></b>
<?php
...
<div class="wrapper_chitiet">
    <div class="hinhanh_sanpham">
        <img width="80%" src="../../modules/quanlysp/uploads/<?php echo $row_chitiet['hinhanh'] ?>">
    </div>
...
<div class="tabs">
  <ul id="tabs-nav">
    ...
    <li><a href="#tab2">Nội dung chi tiết sản phẩm</a></li>
